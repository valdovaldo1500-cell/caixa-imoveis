...
export default function FlippaPage() {
  ...
  const beatSelicCount = useMemo(() => {
    return activeListings.filter((l) => l.price && l.price <= BUDGET_USD && (annualRoi(l.price ?? null, l.monthlyProfit ?? 0) ?? 0) > 14.25).length;
  }, [activeListings]);
