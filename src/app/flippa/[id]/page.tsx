                        ...
                        {flippaListings
                          ...
                          .map((l) => (
                            ...
                            >
                              ...
                              <td className="text-right py-2 px-2 text-zinc-300">{fmt(l.askingPrice ?? null)}</td>
                              <td className="text-right py-2 px-2 text-emerald-400">{fmtMo(l.avgMonthlyProfit ?? 0)}</td>
