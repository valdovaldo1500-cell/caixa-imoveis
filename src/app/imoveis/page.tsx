...
const ALL_COLUMNS = [
  ...
  { id: "descontoMercado", label: "Desc. Merc.", defaultVisible: true, defaultWidth: 75 },
  ...
  { id: "crime", label: "Crime", defaultVisible: true, defaultWidth: 90 },
  { id: "valorMercado", label: "Val. Mercado", defaultVisible: true, sortKey: "market_value", defaultWidth: 120 },
  { id: "mercadoM2", label: "R$/m² Merc.", defaultVisible: false, defaultWidth: 80 },
  { id: "zapM2", label: "ZAP R$/m²", defaultVisible: false, defaultWidth: 80 },
