...
const EXPERT_ASSESSMENTS = [
  ...
  },
  {
    ...
    recommendation: "The 20hrs/week is the dealbreaker for passive management. However, the content is perfect for AI (horror stories) and the engagement metrics are strong. Only buy if you can commit to hiring a dedicated VA (£500-600/mo) who handles ALL production. Negotiate to $95-100K. This is NOT passive — it's a content machine that needs feeding. But if you feed it, it pays well.",
    aiPlan: "Claude writes ALL scripts (horror stories are its strength). VA records voiceover via ElevenLabs, edits video with templates, designs thumbnails, uploads. Owner does topic selection and quality review. Could reduce to 8-10hrs/week with good VA. But still higher effort than content sites.",
  },
  {
    id: "89017",
