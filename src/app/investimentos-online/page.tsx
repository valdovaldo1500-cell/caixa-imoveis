...
const UPDATED_AT = "March 29, 2026 (verified — #90544 CONDITIONAL BUY promoted to #1 pick; Ace Hoops + Faceless Tutorials confirmed)";
                  ...
                  <table className="min-w-[700px] w-full text-sm">
                    <thead>
                      <tr className="border-b border-zinc-700">
                        ...
                        <th className="text-center py-3 px-4 font-medium text-blue-300">Thrive Media (3× Tech YT)<br /><span className="text-blue-500 font-normal text-xs">#90544 — CONDITIONAL BUY</span></th>
                    ...
                    <tbody className="divide-y divide-zinc-800">
                      ...
                      <tr className="bg-zinc-800 border-t-2 border-zinc-600">
                        ...
                        {[
                          ...
                          { score: "4.0/5", color: "text-blue-400" },
                      ...
                      <tr className="border-t border-zinc-700">
                        ...
                        <td className="py-4 px-4 text-center">
                          <span className="inline-block bg-blue-500/10 text-blue-400 border border-blue-500/30 rounded-md px-2 py-1 text-xs font-bold">CONDITIONAL BUY — negotiate to $78-82K</span>
                        </td>
                        <td className="py-4 px-4 text-center">
