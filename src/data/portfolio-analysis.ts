...
export const POST_ACQUISITION_PLAN: PostAcquisitionMilestone[] = [
  ...
  { day: 75, task: "Apply learnings from publishing cadence experiment", details: "Roll out successful changes to Faceless Tutorials channel. Drop unsuccessful experiments.", listing: "91304" },
...
export const ACQUISITION_TIMELINE = [
  ...
  { date: "Apr 1-7", action: "Negotiate", details: "Counter-offers, target Ace Hoops $62K, Faceless Tutorials $45K" },
