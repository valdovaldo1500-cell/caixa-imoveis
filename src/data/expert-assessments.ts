...
export const EXPERT_ASSESSMENTS: ExpertAssessment[] = [
  ...
  {
    id: "QL-FINTECH",
    name: "Fintech Stock Screening SaaS (Quiet Light — 18yr)",
    verdict: "CONSIDER — stable, vetted broker",
    verdictColor: "amber",
    price: "$140,000 (negotiate to $105-115K)",
    monthlyProfit: "~£2,770/mo ($3,500)",
    annualROI: "36-40%",
    trendProfit: "18yr old, $9K MRR, 250 customers, proprietary algorithm, 38% margins",
    trendTraffic: "Quiet Light vetted listing — verified financials",
    highlights: [
      "18 YEARS OLD — extraordinary longevity and stability",
      "250 paying customers — good diversification",
      "$9K MRR with proprietary algorithm",
      "Quiet Light broker = vetted financials (premium platform)",
      "SaaS with genuine recurring revenue",
      "Fintech adjacent — Israel understands financial services",
    ],
    risks: [
      "38% margins — $67K/yr in costs (stock data API fees?)",
      "$140K asking = 3.3x SDE — slightly above market",
      "Need to verify: are costs structural (APIs) or reducible?",
      "250 customers at $36/mo average — low ARPU",
      "Fintech screening is competitive (Finviz, TradingView)",
    ],
    recommendation:
      "CONSIDER at $105-115K. The 18yr track record is unmatched in our entire search. Quiet Light's vetting adds confidence. Key DD: what drives the 38% margin — if API fees are fixed costs, margins improve at scale.",
    aiPlan:
      "If acquired: optimize data API costs, add premium tiers, modernize UI, leverage Israel's enterprise sales background.",
  },
  {
    id: "QL-PARENT",
    name: "Dual-Subscription Parenting Platform (Quiet Light)",
    verdict: "CONSIDER — 2.05x SDE, suspiciously cheap",
    verdictColor: "amber",
    price: "$125,000",
    monthlyProfit: "~£4,030/mo ($5,083)",
    annualROI: "49%",
    trendProfit: "$104K revenue, $61K income, low churn, 6-10hrs/wk",
    trendTraffic: "Quiet Light vetted — dual subscription model",
    highlights: [
      "2.05x SDE multiple — way below market (SaaS avg 3-4x)",
      "$5K/mo income for 6-10hrs/wk — excellent time efficiency",
      "Dual subscription = two revenue streams",
      "Low churn claimed by broker",
      "Quiet Light vetted listing",
    ],
    risks: [
      "Why so cheap at 2.05x? Something must be wrong",
      "Is founder's face/voice in content? (personal brand risk)",
      "Is one subscription through App Store? (non-transferable)",
      "Need to verify both subscription streams are transferable",
      "Parenting niche = no cybersecurity edge",
    ],
    recommendation:
      "CONSIDER at asking ($125K). The 2.05x multiple is the cheapest in our entire Quiet Light scan. MUST verify: (1) no personal brand dependency, (2) both subscriptions transfer to new owner. If clean: buy at asking.",
    aiPlan:
      "If acquired: automate content production with AI, expand to related niches (education, child development), add upsell products.",
  },
  {
    id: "QL-EQUESTRIAN",
    name: "Equestrian Event SaaS (Quiet Light — 292% growth)",
    verdict: "CONSIDER — high growth but over budget",
    verdictColor: "amber",
    price: "$220,000 (negotiate to $185-190K)",
    monthlyProfit: "~£5,020/mo ($6,333)",
    annualROI: "39-41%",
    trendProfit: "292% YoY growth, $121K revenue, $76K income, $2.3K/mo ops cost",
    trendTraffic: "Rapidly growing niche SaaS — equestrian events",
    highlights: [
      "292% YoY revenue growth — fastest growing in entire search",
      "$76K income on just $2.3K/mo operating costs",
      "Quiet Light vetted listing",
      "SaaS for niche events = sticky customers",
      "Strong growth trajectory suggests room to expand",
    ],
    risks: [
      "$220K is over $200K budget — needs negotiation",
      "Why sell a hyper-growth business at 2.9x SDE?",
      "Growth may be one-event spike, not sustainable",
      "Equestrian is very niche — limited TAM",
      "Slightly over budget even after negotiation",
    ],
    recommendation:
      "CONSIDER if budget can stretch to $185-190K. The 292% growth is the highest in our search. Must verify growth is real multi-event trend, not a single spike. Ask broker: why is the seller exiting during hyper-growth?",
    aiPlan:
      "If acquired: expand to other animal/outdoor event verticals, add enterprise features, international expansion.",
  },
  {
    id: "ACQ-SEO-DE",
